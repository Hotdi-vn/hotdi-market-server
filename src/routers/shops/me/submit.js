class SubmitMyOneRouter {
    ...
    routes = async(fastify, options) => {
        ...
        fastify.post(`/v1/${this.settings.resource}/me/submit`, decoration, this.handler.submitMyOne);
    }
}
module.exports = SubmitMyOneRouter;